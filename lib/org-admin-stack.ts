...
export class OrgAdminOrgStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: OrgAdminProps) {
    ...
    // ------- UNCOMMENT THE BELOW to create the scheduled securityhub report that can be sync'd to Security findings knowledge base --------
    // if (cdk.Stack.of(this).region === "ap-southeast-2") { // note the region is the region where Security Hub is enabled

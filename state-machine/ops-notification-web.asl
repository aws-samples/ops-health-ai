{
    ...
    "States": {
        "CheckEventType": {
            ...
            "Choices": [
                ...
                },
                {
                    ...
                    "Next": "CheckWebChatChannelPresent"
                }
            ],
            "Default": "Finished"
        },
        ...
        "CheckWebChatChannelPresent": {
            "Type": "Choice",
            "Choices": [
                {
                    "Variable": "$.detail.SlackChannel",
                    "IsPresent": true,
                    "Next": "WebChatMeOpsAgentResponseWithChannel"
                }
            ],
            "Default": "WebChatMeOpsAgentResponseNoChannel"
        },
        "WebChatMeOpsAgentResponseWithChannel": {
            "Type": "Task",
            "Resource": "arn:aws:states:::lambda:invoke",
            "Parameters": {
                "FunctionName": "${WebChatMeFunctionNamePlaceholder}",
        ...
        "WebChatMeOpsAgentResponseNoChannel": {
            "Type": "Task",
            "Resource": "arn:aws:states:::lambda:invoke",
            "Parameters": {
                "FunctionName": "${WebChatMeFunctionNamePlaceholder}",
